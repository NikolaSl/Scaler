...
| P2.3 | Route reports, commands, hooks and validation through shared version-bound acceptance. | Current independent evidence and integration criteria required; legacy accepted labels are not fresh proof. | In progress: PLAN-102 / PR #6 first closes commit/skip stale-evidence bypass; universal acceptance remains open |
