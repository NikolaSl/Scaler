...
- slash-command MCP enumeration, tool transaction, tool transaction replay, tool replay approval, tool iteration policy/prepare mode, and schema discovery prepare modes with persisted MCP/transaction/probe/iteration/approval records;
