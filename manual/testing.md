...
- deterministic non-software validation checklists persisted through `/scaler-validation-checklist`, task status transitions, and audit logs;
...
- slash-command typed validation gate metadata and non-software checklist persistence and audit logs;
