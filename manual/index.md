...
- Stage I-IV artifact records under `.scaler/stages/` with status commands, focused stage-agent preparation/runs, structured ingestion, one-step stage conductor, readiness validation, advancement, and workflow recommendations.
