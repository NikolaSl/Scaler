...
| Stage conductor | `src/stage-conductor.ts` | One-step active-stage workflow that advances ready artifacts or runs the matching stage agent with ingestion and advancement. |
