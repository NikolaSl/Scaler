        ...
        tasks: [
          {
            ...
            title: "Keep validated real work",
            taskKind: "software",
            atomicityRationale: "T-REAL-KEEP remains independently validated and preserved.",
            prdRefs: ["REQ-REAL-KEEP"],
            allowedPathPrefixes: ["index.js"],
            definitionOfDone: ["Validated real work remains covered."],
            validationRefs: ["validation-real-keep", "test-first"],
            validationCommands: [
          ...
          },
          {
            ...
            taskKind: "software",
            atomicityRationale: "T-REAL-NEW independently covers the newly discovered requirement after T-REAL-KEEP.",
            prdRefs: ["REQ-REAL-NEW"],
            allowedPathPrefixes: ["real-new.js"],
            dependsOn: ["T-REAL-KEEP"],
            definitionOfDone: ["New real requirement has implementation and validation evidence."],
            validationRefs: ["validation-real-new", "test-first"],
            validationCommands: [
              { id: "test-first", command: "node -e \"process.exit(0)\"", gate: "test_first", required: true },
              { id: "unit", command: "npm test", gate: "unit_tests", required: true },
            ],
