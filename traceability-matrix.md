...
| PRD-G04 | Partial | IMPL-021..030, IMPL-046..050, IMPL-061..065 | `src/debug.ts`, `src/validation.ts`, `src/conductor.ts`, `src/subagents.ts`, `src/prd.ts` | `test/debug.test.ts`, `test/validation-runner.test.ts`, `test/conductor.test.ts`, `test/prd.test.ts` | `manual/task-agents.md`, `manual/commands.md`, `manual/runtime-prd.md` | Runtime PRD coverage improves replan inputs; failure-to-debug-to-replan loop not complete. |
...
| PRD-S25 | Partial | IMPL-036..040, IMPL-046..050, IMPL-061..071 | `src/tasks.ts`, `src/workflow.ts`, `src/prd.ts`, `src/plans.ts` | `test/tasks.test.ts`, `test/workflow.test.ts`, `test/prd.test.ts`, `test/plans.test.ts` | `manual/workflow.md`, `manual/runtime-prd.md`, `manual/execution-plans.md` | Runtime PRD ledger and versioned execution plan artifacts exist; evidence-driven replan triggers are not automated. |
...
| PRD-W04 | Partial | IMPL-061..071 | `src/prd.ts`, `src/tasks.ts`, `src/plans.ts`, `src/index.ts` | `test/prd.test.ts`, `test/tasks.test.ts`, `test/plans.test.ts`, `test/extension-shape.test.ts` | `manual/runtime-prd.md`, `manual/execution-plans.md` | Runtime requirement/task links and execution plan artifacts exist; implement planner agent that writes the plan automatically. |
...
| PRD-W08 | Partial | IMPL-036..040, IMPL-046..050, IMPL-061..071 | `src/tasks.ts`, `src/workflow.ts`, `src/prd.ts`, `src/plans.ts` | `test/tasks.test.ts`, `test/workflow.test.ts`, `test/prd.test.ts`, `test/plans.test.ts` | `manual/workflow.md`, `manual/runtime-prd.md`, `manual/execution-plans.md` | Runtime PRD and execution plan versions exist; need evidence-driven pause/replan loop and planner integration. |
