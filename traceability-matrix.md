...
| PRD-S25 | Partial | IMPL-036..040, IMPL-046..050, IMPL-061..065 | `src/tasks.ts`, `src/workflow.ts`, `src/prd.ts` | `test/tasks.test.ts`, `test/workflow.test.ts`, `test/prd.test.ts` | `manual/workflow.md`, `manual/runtime-prd.md` | Runtime PRD ledger preserves requirement coverage and PRD versions; no versioned execution plan/replan artifact yet. |
...
| PRD-W04 | Partial | IMPL-061..065 | `src/prd.ts`, `src/tasks.ts` | `test/prd.test.ts`, `test/tasks.test.ts` | `manual/runtime-prd.md` | Runtime requirement/task links exist; implement planner agent and versioned execution plan. |
...
| PRD-W08 | Partial | IMPL-036..040, IMPL-046..050, IMPL-061..065 | `src/tasks.ts`, `src/workflow.ts`, `src/prd.ts` | `test/tasks.test.ts`, `test/workflow.test.ts`, `test/prd.test.ts` | `manual/workflow.md`, `manual/runtime-prd.md` | Runtime PRD versions and requirement coverage exist; need evidence-driven pause/replan/versioning loop for execution plans. |
