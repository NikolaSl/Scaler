...
|---|---|---|---|
| GAP-001 | PRD-W01..W05, PRD-G01 | Stage I-IV artifact records, commands, focused stage-agent runs, structured artifact ingestion, ready-artifact validation, deterministic semantic advancement gates, stage advancement, and one-step/bounded staged conductors exist, but stage outputs are not checked for cross-artifact PRD/plan consistency. | Add PRD/plan consistency gates that compare PRD requirements, knowledge evidence, planning tasks, replanning proposals, and execution task refs. |
