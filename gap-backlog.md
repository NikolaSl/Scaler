...
| GAP-003 | PRD-S25, PRD-S31, PRD-W08, PRD-G04 | Versioned runtime PRD and execution plan artifacts exist, but evidence-driven replanning triggers and plan replacement workflow are still missing. | Add replan request records, evidence packages, automatic pause-to-replan triggers, and preservation checks for validated tasks/coverage. |
