...
|---|---|---|---|
| GAP-001 | PRD-W01..W05, PRD-G01 | Stage I-IV artifact records, commands, focused stage-agent runs, structured artifact ingestion, ready-artifact validation, deterministic stage advancement, and one-step/bounded staged conductors exist, but stage outputs are not deeply validated against PRD/plan semantics. | Add semantic artifact checks and PRD/plan consistency gates for PRD, knowledge, planning, replanning, and execution artifacts. |
